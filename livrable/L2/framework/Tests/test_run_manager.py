...
@pytest.fixture
def temp_dir():
    """Crée un répertoire temporaire pour les tests, nettoyé après chaque test."""
...
def manager(temp_dir):
    ...
    return RunFileManager(str(temp_dir / "results"))
...
class TestRun:
    ...
    def test_save_and_load(self, temp_dir, simple_config, simple_results):
        ...
        filepath = temp_dir / "test_run.json"
        run.save(filepath)
    ...
    def test_save_creates_directory(self, temp_dir, simple_config, simple_results):
        ...
        nested_path = temp_dir / "nested" / "path" / "run.json"
    ...
    def test_load_nonexistent_file(self, temp_dir):
        ...
        with pytest.raises(FileNotFoundError):
            Run.load(temp_dir / "nonexistent.json")
...
class TestRunFileManager:
    ...
    def test_init_creates_directory(self, temp_dir):
        ...
        manager = RunFileManager(str(temp_dir / "new_results"))
